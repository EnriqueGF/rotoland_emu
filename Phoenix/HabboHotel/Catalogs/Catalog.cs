...
namespace Phoenix.HabboHotel.Catalogs
{
	internal sealed class Catalog
	{
		...
		public void method_0(DatabaseClient class6_0)
		{
			...
			if (dataTable3 != null)
			{
				foreach (DataRow dataRow in dataTable3.Rows)
				{
					...
					{
						hashtable.Add((uint)dataRow["Id"], new CatalogItem((uint)dataRow["Id"], (string)dataRow["catalog_name"], (string)dataRow["item_ids"], (int)dataRow["cost_credits"], (int)dataRow["cost_pixels"], (int)dataRow["cost_snow"], (int)dataRow["amount"], (int)dataRow["page_id"], Phoenix.smethod_2(dataRow["vip"].ToString()), (uint)dataRow["achievement"]));
					}
				}
			}
			if (dataTable != null)
		...
		public bool method_6(GameClient Session, int int_0, uint uint_1, string string_0, bool bool_0, string string_1, string string_2, bool bool_1)
		{
			...
			{
				if (@class.bool_2 && (!Session.GetHabbo().method_20().method_2("habbo_club") || !Session.GetHabbo().method_20().method_2("habbo_vip")))
				{
					return false;
				}
				else
						...
						else
						{
							...
							else
							{
									...
									if (!(text == "pet"))
									{
										...
										if (text == "trophy")
										{
											string_0 = string.Concat(new object[]
											{
												...
												DateTime.Now.Year,
												Convert.ToChar(9),
												ChatCommandHandler.smethod_4(Phoenix.DoFilter(string_0, true, true))
											});
											goto IL_4FC;
										}
									}
								...
								if (bool_0)
								{
									...
									using (DatabaseClient class3 = Phoenix.GetDatabase().GetClient())
									{
										class3.AddParamWithValue("gift_message", "!" + ChatCommandHandler.smethod_4(Phoenix.DoFilter(string_2, true, true)) + " - " + Session.GetHabbo().Username);
										...
										if (num4 <= 60)
										{
											if (num4 <= 15)
											{
												if (num4 != 5)
												{
													if (num4 == 15)
													{
														Phoenix.GetGame().GetAchievementManager().addAchievement(class5, 25u, 2);
													}
												}
												else
												{
													Phoenix.GetGame().GetAchievementManager().addAchievement(class5, 25u, 1);
												}
											}
											else
											{
												if (num4 != 35)
												{
													if (num4 != 50)
													{
														if (num4 == 60)
														{
															Phoenix.GetGame().GetAchievementManager().addAchievement(class5, 25u, 5);
														}
													}
													else
													{
														Phoenix.GetGame().GetAchievementManager().addAchievement(class5, 25u, 4);
													}
												}
												else
												{
													Phoenix.GetGame().GetAchievementManager().addAchievement(class5, 25u, 3);
												}
											}
										}
										else
										{
											if (num4 <= 120)
											{
												if (num4 != 80)
												{
													if (num4 == 120)
													{
														Phoenix.GetGame().GetAchievementManager().addAchievement(class5, 25u, 7);
													}
												}
												else
												{
													Phoenix.GetGame().GetAchievementManager().addAchievement(class5, 25u, 6);
												}
											}
											else
											{
												if (num4 != 140)
												{
													if (num4 != 160)
													{
														if (num4 == 200)
														{
															Phoenix.GetGame().GetAchievementManager().addAchievement(class5, 25u, 10);
														}
													}
													else
													{
														Phoenix.GetGame().GetAchievementManager().addAchievement(class5, 25u, 9);
													}
												}
												else
												{
													Phoenix.GetGame().GetAchievementManager().addAchievement(class5, 25u, 8);
												}
											}
										}
									}
									...
									if (num4 <= 60)
									{
										if (num4 <= 15)
										{
											if (num4 != 5)
											{
												if (num4 == 15)
												{
													Phoenix.GetGame().GetAchievementManager().addAchievement(Session, 24u, 2);
												}
											}
											else
											{
												Phoenix.GetGame().GetAchievementManager().addAchievement(Session, 24u, 1);
											}
										}
										else
										{
											if (num4 != 35)
											{
												if (num4 != 50)
												{
													if (num4 == 60)
													{
														Phoenix.GetGame().GetAchievementManager().addAchievement(Session, 24u, 5);
													}
												}
												else
												{
													Phoenix.GetGame().GetAchievementManager().addAchievement(Session, 24u, 4);
												}
											}
											else
											{
												Phoenix.GetGame().GetAchievementManager().addAchievement(Session, 24u, 3);
											}
										}
									}
									else
									{
										if (num4 <= 120)
										{
											if (num4 != 80)
											{
												if (num4 == 120)
												{
													Phoenix.GetGame().GetAchievementManager().addAchievement(Session, 24u, 7);
												}
											}
											else
											{
												Phoenix.GetGame().GetAchievementManager().addAchievement(Session, 24u, 6);
											}
										}
										else
										{
											if (num4 != 140)
											{
												if (num4 != 160)
												{
													if (num4 == 200)
													{
														Phoenix.GetGame().GetAchievementManager().addAchievement(Session, 24u, 10);
													}
												}
												else
												{
													Phoenix.GetGame().GetAchievementManager().addAchievement(Session, 24u, 9);
												}
											}
											else
											{
												Phoenix.GetGame().GetAchievementManager().addAchievement(Session, 24u, 8);
											}
										}
									}
								...
								else
								{
									...
									if (class2.uint_2 > 0u)
									{
										Phoenix.GetGame().GetAchievementManager().addAchievement(Session, class2.uint_2, 1);
									}
									return true;
								}
							}
		...
		public void method_7(string string_0, uint uint_1, uint uint_2, int int_0)
		{
			...
			{
				class4.AddParamWithValue("gift_message", "!" + ChatCommandHandler.smethod_4(Phoenix.DoFilter(string_0, true, true)));
		...
		public void method_9(GameClient Session, Item Item, int int_0, string string_0, bool bool_0, uint uint_1)
		{
			...
			if (text != null)
			{
				...
				if (text == "h")
				{
					for (int i = 0; i < int_0; i++)
					{
						Session.GetHabbo().method_20().method_3("habbo_club", 2678400);
					}
					if (!Session.GetHabbo().method_22().method_1("HC1"))
					{
						Session.GetHabbo().method_22().method_2(Session, "HC1", true);
					}
					...
					{
						double num3 = (double)Session.GetHabbo().method_20().method_1("habbo_club").Int32_0;
					...
					else
					{
						...
						else
						{
							...
							{
								if (Session.GetHabbo().Vip || LicenseTools.Boolean_3 || Session.GetHabbo().method_20().method_2("habbo_club"))
								{
									Message3.AppendInt32(2);
								}
								else
