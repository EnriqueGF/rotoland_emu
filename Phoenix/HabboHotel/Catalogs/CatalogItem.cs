...
namespace Phoenix.Catalogs
{
	internal sealed class CatalogItem
	{
		...
		public CatalogItem(uint uint_3, string string_1, string string_2, int int_6, int int_7, int int_8, int int_9, int int_10, int int_11, uint uint_4)
		{
			this.uint_0 = uint_3;
		...
		public void method_1(ServerMessage Message5_0)
		{
			...
			{
				Message5_0.AppendStringWithBreak(Phoenix.GetGame().GetItemManager().method_4(Convert.ToInt32(this.string_0.Split(new char[]
				{
					'_'
				})[1])).Name);
			}
