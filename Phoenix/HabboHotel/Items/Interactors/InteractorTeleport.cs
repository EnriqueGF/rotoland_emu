...
namespace Phoenix.HabboHotel.Items.Interactors
{
	internal sealed class InteractorTeleport : FurniInteractor
	{
		public override void OnPlace(GameClient Session, RoomItem RoomItem_0)
		{
			...
			{
				RoomUser @class = RoomItem_0.method_8().method_53(RoomItem_0.uint_3);
				if (@class != null)
				{
					@class.method_3(true);
					@class.bool_1 = false;
			...
			{
				RoomUser @class = RoomItem_0.method_8().method_53(RoomItem_0.uint_4);
				if (@class != null)
				{
					@class.method_3(true);
					@class.bool_1 = false;
		...
		{
			RoomUser @class = RoomItem_0.method_8().method_53(Session.GetHabbo().Id);
