...
namespace Phoenix.HabboHotel.Items
{
	internal sealed class RoomItem
	{
		...
		public RoomItem(uint uint_5, uint uint_6, uint uint_7, string string_8, int int_5, int int_6, double double_1, int int_7, string string_9, Room class14_1)
		{
			...
			this.Item = Phoenix.GetGame().GetItemManager().method_2(uint_7);
		...
		internal void method_2()
		{
			...
			if (this.int_4 <= 0)
			{
				...
				if (this.bool_0 && this.int_0 > 0)
				{
					...
					this.bool_1 = true;
					if (this.int_0 > Phoenix.GetGame().GetItemManager().method_4(Convert.ToInt32(this.ExtraData)).Length)
					{
				...
				else
				{
					...
					case "teleport":
					{
						...
						if (this.uint_3 > 0u)
						{
							RoomUser @class = this.method_8().method_53(this.uint_3);
							if (@class != null)
							{
									...
									if (TeleHandler.smethod_2(this.uint_0))
									{
										...
										if (@class.int_19 == 0)
										{
											...
											else
											{
												if (!@class.Boolean_4)
												{
													Phoenix.GetGame().GetRoomManager().method_5(new TeleUserData(@class.GetClient().method_1(), @class.GetClient().GetHabbo(), num3, num2));
												}
											}
											this.uint_3 = 0u;
										}
						...
						if (this.uint_4 > 0u)
						{
							RoomUser class3 = this.method_8().method_53(this.uint_4);
							if (class3 != null)
							{
								flag = true;
								class3.method_6();
					...
					case "vendingmachine":
						if (this.ExtraData == "1")
						{
							...
							{
								@class.method_6();
								int int_ = this.GetBaseItem().VendingIds[Phoenix.smethod_5(0, this.GetBaseItem().VendingIds.Count - 1)];
								@class.method_8(int_);
							}
							this.uint_3 = 0u;
							this.ExtraData = "0";
					...
					case "counter":
						if (this.bool_0 && this.string_2 != "1")
						{
							...
							this.method_8().method_16((double)Convert.ToInt32(this.ExtraData));
							this.string_2 = "1";
							this.ReqUpdate(1);
						}
						else
						{
							if (this.bool_0)
							{
								this.method_8().method_16((double)Convert.ToInt32(this.ExtraData) - 0.5);
								this.string_2 = "0";
								this.ReqUpdate(1);
							}
						}
		...
		internal Item GetBaseItem()
		{
			if (this.Item == null)
			{
				this.Item = Phoenix.GetGame().GetItemManager().method_2(this.uint_2);
			}
			return this.Item;
		}
