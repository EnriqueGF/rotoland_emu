	...
	internal sealed class Room
	{
		...
		public int Int32_0
		{
			get
			{
				...
				else
				{
					...
					{
						if (this.RoomUser_0[i] != null && !this.RoomUser_0[i].Boolean_4 && !this.RoomUser_0[i].isPet)
						{
							num++;
						}
					}
		...
		public bool Boolean_2
		{
			get
			{
				...
				{
					FlatCat @class = Phoenix.GetGame().GetNavigator().method_2(this.Category);
		...
		{
			List<RoomBot> list = Phoenix.GetGame().GetBotManager().method_2(this.Id);
			...
			if (string_10 != null)
			{
				...
				if (MusCommands.dictionary_4.TryGetValue(string_10, out num))
				{
					...
					case 4:
						...
						goto IL_89E;
					case 5:
						result = Phoenix.GetGame().GetAchievementManager().method_1(RoomUser_1.GetClient(), (uint)Convert.ToUInt16(string_11), 1);
						return result;
					case 6:
						if (!Phoenix.GetGame().GetAchievementManager().method_1(RoomUser_1.GetClient(), (uint)Convert.ToUInt16(string_11), 1))
						{
							result = true;
							return result;
						}
					...
					case 36:
						...
						goto IL_89E;
					case 37:
						if (this.method_53(RoomUser_1.GetClient().GetHabbo().Id).int_5 == (int)Convert.ToInt16(string_11))
						{
							result = true;
							return result;
						}
		...
		public void method_19(RoomUser RoomUser_1, string string_10, string string_11)
		{
			string_11 = this.method_20(RoomUser_1, string_11);
			if (string_10 != null)
			{
				...
				if (MusCommands.dictionary_5.TryGetValue(string_10, out num))
				{
					...
					case 3:
						if (RoomUser_1.GetClient() != null)
						{
							Phoenix.GetGame().GetAchievementManager().addAchievement(RoomUser_1.GetClient(), Convert.ToUInt32(string_11));
							return;
						}
						return;
					case 4:
						if (RoomUser_1.GetClient() != null)
						{
							RoomUser class2 = this.method_53(RoomUser_1.GetClient().GetHabbo().Id);
					...
					case 8:
						...
						return;
					case 9:
						if (RoomUser_1.GetClient() != null && (int)Convert.ToUInt16(string_11) < Phoenix.GetGame().GetRoleManager().method_9())
						{
							using (DatabaseClient @class = Phoenix.GetDatabase().GetClient())
							{
					...
					case 10:
					{
						...
						int int_ = RoomUser_1.GetClient().GetHabbo().Respect;
						if (int_ <= 166)
						{
							if (int_ <= 6)
							{
								if (int_ == 1)
								{
									Phoenix.GetGame().GetAchievementManager().addAchievement(RoomUser_1.GetClient(), 14u, 1);
									return;
								}
								if (int_ != 6)
								{
								...
								Phoenix.GetGame().GetAchievementManager().addAchievement(RoomUser_1.GetClient(), 14u, 2);
								return;
							}
							else
							{
								if (int_ == 16)
								{
									Phoenix.GetGame().GetAchievementManager().addAchievement(RoomUser_1.GetClient(), 14u, 3);
									return;
								}
								if (int_ == 66)
								{
									Phoenix.GetGame().GetAchievementManager().addAchievement(RoomUser_1.GetClient(), 14u, 4);
									return;
								}
								if (int_ != 166)
								{
								...
								Phoenix.GetGame().GetAchievementManager().addAchievement(RoomUser_1.GetClient(), 14u, 5);
								return;
							}
						}
						else
						{
							if (int_ <= 566)
							{
								if (int_ == 366)
								{
									Phoenix.GetGame().GetAchievementManager().addAchievement(RoomUser_1.GetClient(), 14u, 6);
									return;
								}
								if (int_ != 566)
								{
								...
								Phoenix.GetGame().GetAchievementManager().addAchievement(RoomUser_1.GetClient(), 14u, 7);
								return;
							}
							else
							{
								if (int_ == 766)
								{
									Phoenix.GetGame().GetAchievementManager().addAchievement(RoomUser_1.GetClient(), 14u, 8);
									return;
								}
								if (int_ == 966)
								{
									Phoenix.GetGame().GetAchievementManager().addAchievement(RoomUser_1.GetClient(), 14u, 9);
									return;
								}
								if (int_ != 1116)
								{
								...
								Phoenix.GetGame().GetAchievementManager().addAchievement(RoomUser_1.GetClient(), 14u, 10);
								return;
							}
						}
					}
					case 11:
						if (RoomUser_1.GetClient() != null)
						{
							this.method_53(RoomUser_1.GetClient().GetHabbo().Id).method_8((int)Convert.ToInt16(string_11));
							return;
						}
						return;
					case 12:
					...
					if (RoomUser_1.GetClient() != null)
					{
						RoomUser_1.GetClient().GetHabbo().method_22().method_2(RoomUser_1.GetClient(), Phoenix.FilterString(string_11), true);
						...
						foreach (RoomItem current2 in list3)
						{
							...
							if (text != null)
							{
											...
											using (List<RoomItem>.Enumerator enumerator3 = list4.GetEnumerator())
											{
												while (enumerator3.MoveNext())
												{
													...
													if (current4 != null)
													{
														...
														List<RoomItem> list5 = new List<RoomItem>(this.method_45(current4.Int32_0, current4.Int32_1));
														...
														{
															list5 = new List<RoomItem>(this.method_45(current5.Int32_0, current5.Int32_1));
															if (list5.Count > 1 && num4 + 1 != num2)
															{
																num2++;
																break;
								...
								if (current2.string_2.Length > 0)
								{
									...
									if (RoomUser_1 != null)
									{
										if (!RoomUser_1.Boolean_4 && this.method_18(RoomUser_1, string_11, string_12))
										{
											num2++;
										}
									}
						...
						foreach (RoomItem current2 in list6)
						{
							...
							case "wf_act_give_phx":
								...
								if (current2.string_2.Length > 0)
								{
									...
									if (RoomUser_1 != null)
									{
										if (!RoomUser_1.Boolean_4)
										{
											this.method_19(RoomUser_1, string_11, string_12);
										}
									}
									else
									{
				...
				try
				{
					if (@class.GetBaseItem().Type == 's')
					{
						if (@class.Int32_0 >= this.Class28_0.int_4 || @class.Int32_1 >= this.Class28_0.int_5 || @class.Int32_1 < 0 || @class.Int32_0 < 0)
						{
							...
							if (class2 != null)
							{
								class2.GetHabbo().method_23().method_11(@class.uint_0, @class.uint_2, @class.ExtraData, true);
							}
						}
						else
						{
		...
		{
			return this.method_27(Session, false);
		}
		public bool method_27(GameClient Session, bool bool_13)
		{
			bool result;
			try
			{
				...
				if (!bool_13)
				{
					...
					if (this.list_1.Contains(Session.GetHabbo().Id))
					{
						result = true;
						return result;
					}
					...
					if (this.RoomUser_0 != null)
					{
						try
						{
							for (int i = 0; i < this.RoomUser_0.Length; i++)
							{
								...
								{
									num = 1;
									if (!class3.Boolean_4 && class3.GetClient() != null)
									{
										num3++;
									...
									num = 3;
									if (class3.GetClient() == null && !class3.Boolean_4)
									{
										this.RoomUser_0[i] = null;
										if (!class3.bool_1)
										{
									...
									{
										num = 7;
										if (class3.Boolean_4 && class3.class34_0.RoomUser_0 != null && this.method_30(class3.int_12, class3.int_13, 0.0, true, true))
										{
											num = 8;
									...
									if (class3.bool_6 && !class3.bool_5 && class3.class34_1 == null)
									{
										...
										if (@struct.X != class3.int_3 || @struct.Y != class3.int_4)
										{
											...
											num = 13;
											if (class3.Boolean_4 && class3.class34_0.RoomUser_0 != null)
											{
												class3.class34_0.RoomUser_0.method_11("mv", string.Concat(new object[]
												{
													int32_,
													",",
													int32_2,
											...
											if (class3.Boolean_4 && class3.class34_0.RoomUser_0 != null)
											{
												...
												class3.class34_0.RoomUser_0.bool_7 = true;
												goto IL_BE0;
											}
											goto IL_BE0;
											IL_CE1:
									...
									if (class3.Boolean_4 || class3.isPet)
									{
										try
										{
		...
		private void method_34()
		{
			if (!this.bool_7 && LicenseTools.bool_18)
			{
				...
				try
				{
					this.method_31(PhoenixEnvironment.smethod_1("error_roomunload"));
				}
				catch
				{
				}
						...
						if (@class.Boolean_0)
						{
							...
							if (list3.Count > 0 || class2 != null)
							{
								...
								if (class2 != null && (!flag2 || !flag3) && this.method_37(gStruct1_.x, gStruct1_.y, false, true, false, true, true) && !list2.Contains(class2.uint_0) && !class2.bool_6)
								{
									...
									if (class2.Boolean_4 && class2.class34_0.RoomUser_0 != null)
									{
		...
		public void method_46(GameClient Session, bool bool_13)
		{
			...
			if (@class != null && @class.GetClient() != null && @class.GetClient().GetHabbo() != null)
			{
				...
				else
				{
					...
					if (this.method_27(Session, true))
					{
					...
					if (!@class.Boolean_4 && @class.GetClient().GetHabbo().bool_7)
					{
				...
				if (num2 <= 500)
				{
					if (num2 <= 50)
					{
						if (num2 != 5)
						{
							if (num2 == 50)
							{
								Phoenix.GetGame().GetAchievementManager().addAchievement(Session, 13u, 2);
							}
						}
						else
						{
							Phoenix.GetGame().GetAchievementManager().addAchievement(Session, 13u, 1);
						}
					}
					else
					{
						if (num2 != 100)
						{
							if (num2 != 200)
							{
								if (num2 == 500)
								{
									Phoenix.GetGame().GetAchievementManager().addAchievement(Session, 13u, 5);
								}
							}
							else
							{
								Phoenix.GetGame().GetAchievementManager().addAchievement(Session, 13u, 4);
							}
						}
						else
						{
							Phoenix.GetGame().GetAchievementManager().addAchievement(Session, 13u, 3);
						}
					}
				}
				else
				{
					if (num2 <= 1500)
					{
						if (num2 != 750)
						{
							if (num2 == 1500)
							{
								Phoenix.GetGame().GetAchievementManager().addAchievement(Session, 13u, 7);
							}
						}
						else
						{
							Phoenix.GetGame().GetAchievementManager().addAchievement(Session, 13u, 6);
						}
					}
					else
					{
						if (num2 != 2500)
						{
							if (num2 != 4000)
							{
								if (num2 == 5000)
								{
									Phoenix.GetGame().GetAchievementManager().addAchievement(Session, 13u, 10);
								}
							}
							else
							{
								Phoenix.GetGame().GetAchievementManager().addAchievement(Session, 13u, 9);
							}
						}
						else
						{
							Phoenix.GetGame().GetAchievementManager().addAchievement(Session, 13u, 8);
						}
					}
				}
			...
			if (!bool_14 || !Session.GetHabbo().isAaron)
			{
				...
				else
				{
					try
					{
						...
						{
							num = 2;
							RoomUser @class = this.method_53(Session.GetHabbo().Id);
							if (@class != null)
							{
		...
		public RoomUser method_48(uint uint_2)
		{
			...
			{
				RoomUser @class = this.RoomUser_0[i];
				if (@class != null && @class.Boolean_4 && @class.isPet && @class.PetData != null && @class.PetData.PetId == uint_2)
				{
					result = @class;
					return result;
				}
		...
		public RoomUser method_53(uint uint_2)
		{
			RoomUser result;
			for (int i = 0; i < this.RoomUser_0.Length; i++)
			{
		...
		public RoomUser method_56(string string_10)
		{
			...
			{
				RoomUser @class = this.RoomUser_0[i];
				if (@class != null && !@class.Boolean_4 && @class.GetClient().GetHabbo() != null && @class.GetClient().GetHabbo().Username.ToLower() == string_10.ToLower())
				{
					result = @class;
					return result;
				}
		...
		public RoomUser method_57(string string_10)
		{
			...
			{
				RoomUser @class = this.RoomUser_0[i];
				if (@class != null && @class.Boolean_4 && @class.class34_0.Name.ToLower() == string_10.ToLower())
				{
					result = @class;
					return result;
				}
		...
		{
			return !RoomUser_1.Boolean_4 && this.method_74(RoomUser_1.GetClient().GetHabbo().Id);
		}
		...
		{
			if (RoomUser_1 != null && RoomUser_2 != null && (!RoomUser_1.Boolean_4 || RoomUser_1.class34_0.Boolean_1) && (!RoomUser_2.Boolean_4 || RoomUser_2.class34_0.Boolean_1) && !RoomUser_1.Boolean_3 && !RoomUser_2.Boolean_3 && !this.method_73(RoomUser_1) && !this.method_73(RoomUser_2))
			{
			...
			else
			{
				...
				else
				{
					...
					if (RoomItem_0.GetBaseItem().InteractionType.ToLower() == "wf_act_give_phx" && Session != null)
					{
						...
						if (!Phoenix.GetGame().GetRoleManager().method_12(text2, Session))
						{
							RoomItem_0.string_2 = "";
						}
					}
					if (RoomItem_0.GetBaseItem().InteractionType.ToLower() == "wf_cnd_phx" && Session != null)
					{
						...
						if (!Phoenix.GetGame().GetRoleManager().method_11(text2, Session))
						{
							RoomItem_0.string_2 = "";
						}
					}
				...
				if (text != null)
				{
					if (!(text == "pressure_pad"))
					{
						if (text == "fbgate" && (!string.IsNullOrEmpty(current.string_2) || !string.IsNullOrEmpty(current.string_3)))
						{
							...
							if (RoomUser_1 != null && !RoomUser_1.Boolean_4 && current.string_2 != null && current.string_3 != null)
							{
					...
					else
					{
						...
						if (bool_13)
						{
                            ...
                            if (this.Class28_0.squareState[User.int_3, User.int_4] == SquareState.SEAT)
							{
								...
								if (User.Boolean_4 && User.class34_0.RoomUser_0 != null)
								{
								...
								foreach (RoomItem Item in list)
								{
									...
									if (Item.GetBaseItem().InteractionType.ToLower().IndexOf("bb_") > -1 && !User.Boolean_4)
									{
										if (Item.GetBaseItem().InteractionType.ToLower().IndexOf("_gate") > -1)
										{
											...
											{
												User.GetClient().GetHabbo().method_24().method_2(num4, true);
												User.bool_7 = true;
												User.int_14 = num5;
										...
										if (Item.GetBaseItem().InteractionType.ToLower() == "bb_patch" && User.int_14 > 0 && User.bool_6 && Item.ExtraData != "14" && Item.ExtraData != "5" && Item.ExtraData != "8" && Item.ExtraData != "11" && Item.ExtraData != "1")
										{
		...
		public void method_91(RoomItem RoomItem_0, RoomUser RoomUser_1)
		{
			...
			if (list.Count > 0)
			{
				Random random = new Random((int)Phoenix.GetUnixTimestamp() * (int)RoomUser_1.uint_0);
