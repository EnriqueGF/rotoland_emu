	...
	internal sealed class PetBot : BotAI
	{
		...
		public override void OnUserLeaveRoom(GameClient Session)
		{
			if (Session != null && Session.GetHabbo() != null)
			{
				...
				RoomUser @class = base.method_1().method_53(Session.GetHabbo().Id);
					...
					if (string_0.ToLower().StartsWith(@class.PetData.Name.ToLower() + " ") && RoomUser_0.GetClient().GetHabbo().Username.ToLower() == base.GetRoomUser().PetData.OwnerName.ToLower())
					{
						...
						if ((@class.PetData.Energy >= 10 && this.method_4() < 6) || @class.PetData.Level >= 15)
						{
							...
							if (!Phoenix.GetGame().GetRoleManager().dictionary_5.ContainsKey(key))
							{
								...
								{
									PhoenixEnvironment.smethod_1("pet_response_confused1"),
									PhoenixEnvironment.smethod_1("pet_response_confused2"),
									PhoenixEnvironment.smethod_1("pet_response_confused3"),
									PhoenixEnvironment.smethod_1("pet_response_confused4"),
									PhoenixEnvironment.smethod_1("pet_response_confused5"),
									PhoenixEnvironment.smethod_1("pet_response_confused6"),
									PhoenixEnvironment.smethod_1("pet_response_confused7")
								};
							...
							else
							{
								...
								case 1:
									...
									@class.method_1(null, PhoenixEnvironment.smethod_1("pet_response_sleep"), false);
								...
								case 10:
									...
									@class.method_1(null, PhoenixEnvironment.smethod_1("pet_response_silent"), false);
									this.int_2 = 120;
									break;
								case 11:
									@class.PetData.AddExpirience(15, 15);
						...
						else
						{
							...
							{
								PhoenixEnvironment.smethod_1("pet_response_sleeping1"),
								PhoenixEnvironment.smethod_1("pet_response_sleeping2"),
								PhoenixEnvironment.smethod_1("pet_response_sleeping3"),
								PhoenixEnvironment.smethod_1("pet_response_sleeping4"),
								PhoenixEnvironment.smethod_1("pet_response_sleeping5")
							};
							string[] array3 = new string[]
							{
								PhoenixEnvironment.smethod_1("pet_response_refusal1"),
								PhoenixEnvironment.smethod_1("pet_response_refusal2"),
								PhoenixEnvironment.smethod_1("pet_response_refusal3"),
								PhoenixEnvironment.smethod_1("pet_response_refusal4"),
								PhoenixEnvironment.smethod_1("pet_response_refusal5")
							};
		...
		public override void OnTimerTick()
		{
			if (this.int_2 <= 0)
			{
				...
				string[] array = new string[]
				{
					PhoenixEnvironment.smethod_1("pet_chatter_dog1"),
					PhoenixEnvironment.smethod_1("pet_chatter_dog2"),
					PhoenixEnvironment.smethod_1("pet_chatter_dog3"),
					PhoenixEnvironment.smethod_1("pet_chatter_dog4"),
					PhoenixEnvironment.smethod_1("pet_chatter_dog5")
				};
				string[] array2 = new string[]
				{
					PhoenixEnvironment.smethod_1("pet_chatter_cat1"),
					PhoenixEnvironment.smethod_1("pet_chatter_cat2"),
					PhoenixEnvironment.smethod_1("pet_chatter_cat3"),
					PhoenixEnvironment.smethod_1("pet_chatter_cat4"),
					PhoenixEnvironment.smethod_1("pet_chatter_cat5")
				};
				string[] array3 = new string[]
				{
					PhoenixEnvironment.smethod_1("pet_chatter_croc1"),
					PhoenixEnvironment.smethod_1("pet_chatter_croc2"),
					PhoenixEnvironment.smethod_1("pet_chatter_croc3"),
					PhoenixEnvironment.smethod_1("pet_chatter_croc4"),
					PhoenixEnvironment.smethod_1("pet_chatter_croc5")
				};
				...
				{
					PhoenixEnvironment.smethod_1("pet_chatter_bear1"),
					PhoenixEnvironment.smethod_1("pet_chatter_bear2"),
					PhoenixEnvironment.smethod_1("pet_chatter_bear3"),
					PhoenixEnvironment.smethod_1("pet_chatter_bear4"),
					PhoenixEnvironment.smethod_1("pet_chatter_bear5")
				};
				string[] array6 = new string[]
				{
					PhoenixEnvironment.smethod_1("pet_chatter_pig1"),
					PhoenixEnvironment.smethod_1("pet_chatter_pig2"),
					PhoenixEnvironment.smethod_1("pet_chatter_pig3"),
					PhoenixEnvironment.smethod_1("pet_chatter_pig4"),
					PhoenixEnvironment.smethod_1("pet_chatter_pig5")
				};
				string[] array7 = new string[]
				{
					PhoenixEnvironment.smethod_1("pet_chatter_lion1"),
					PhoenixEnvironment.smethod_1("pet_chatter_lion2"),
					PhoenixEnvironment.smethod_1("pet_chatter_lion3"),
					PhoenixEnvironment.smethod_1("pet_chatter_lion4"),
					PhoenixEnvironment.smethod_1("pet_chatter_lion5")
				};
				string[] array8 = new string[]
				{
					PhoenixEnvironment.smethod_1("pet_chatter_rhino1"),
					PhoenixEnvironment.smethod_1("pet_chatter_rhino2"),
					PhoenixEnvironment.smethod_1("pet_chatter_rhino3"),
					PhoenixEnvironment.smethod_1("pet_chatter_rhino4"),
					PhoenixEnvironment.smethod_1("pet_chatter_rhino5")
				};
				string[] array9 = new string[]
				{
					PhoenixEnvironment.smethod_1("pet_chatter_spider1"),
					PhoenixEnvironment.smethod_1("pet_chatter_spider2"),
					PhoenixEnvironment.smethod_1("pet_chatter_spider3"),
					PhoenixEnvironment.smethod_1("pet_chatter_spider4"),
					PhoenixEnvironment.smethod_1("pet_chatter_spider5")
				};
				string[] array10 = new string[]
				{
					PhoenixEnvironment.smethod_1("pet_chatter_turtle1"),
					PhoenixEnvironment.smethod_1("pet_chatter_turtle2"),
					PhoenixEnvironment.smethod_1("pet_chatter_turtle3"),
					PhoenixEnvironment.smethod_1("pet_chatter_turtle4"),
					PhoenixEnvironment.smethod_1("pet_chatter_turtle5")
				};
				string[] array11 = new string[]
				{
					PhoenixEnvironment.smethod_1("pet_chatter_chic1"),
					PhoenixEnvironment.smethod_1("pet_chatter_chic2"),
					PhoenixEnvironment.smethod_1("pet_chatter_chic3"),
					PhoenixEnvironment.smethod_1("pet_chatter_chic4"),
					PhoenixEnvironment.smethod_1("pet_chatter_chic5")
				};
				string[] array12 = new string[]
				{
					PhoenixEnvironment.smethod_1("pet_chatter_frog1"),
					PhoenixEnvironment.smethod_1("pet_chatter_frog2"),
					PhoenixEnvironment.smethod_1("pet_chatter_frog3"),
					PhoenixEnvironment.smethod_1("pet_chatter_frog4"),
					PhoenixEnvironment.smethod_1("pet_chatter_frog5")
				};
				string[] array13 = new string[]
				{
					PhoenixEnvironment.smethod_1("pet_chatter_dragon1"),
					PhoenixEnvironment.smethod_1("pet_chatter_dragon2"),
					PhoenixEnvironment.smethod_1("pet_chatter_dragon3"),
					PhoenixEnvironment.smethod_1("pet_chatter_dragon4"),
					PhoenixEnvironment.smethod_1("pet_chatter_dragon5")
				};
				string[] array14 = new string[]
				{
					PhoenixEnvironment.smethod_1("pet_chatter_horse1"),
					PhoenixEnvironment.smethod_1("pet_chatter_horse2"),
					PhoenixEnvironment.smethod_1("pet_chatter_horse3"),
					PhoenixEnvironment.smethod_1("pet_chatter_horse4"),
					PhoenixEnvironment.smethod_1("pet_chatter_horse5")
				};
				string[] array15 = new string[]
				{
					PhoenixEnvironment.smethod_1("pet_chatter_monkey1"),
					PhoenixEnvironment.smethod_1("pet_chatter_monkey2"),
					PhoenixEnvironment.smethod_1("pet_chatter_monkey3"),
					PhoenixEnvironment.smethod_1("pet_chatter_monkey4"),
					PhoenixEnvironment.smethod_1("pet_chatter_monkey5")
				};
				string[] array16 = new string[]
				{
					PhoenixEnvironment.smethod_1("pet_chatter_generic1"),
					PhoenixEnvironment.smethod_1("pet_chatter_generic2"),
					PhoenixEnvironment.smethod_1("pet_chatter_generic3"),
					PhoenixEnvironment.smethod_1("pet_chatter_generic4"),
					PhoenixEnvironment.smethod_1("pet_chatter_generic5")
				};
