...
namespace Phoenix.HabboHotel.Users.Inventory
{
	internal sealed class AvatarEffectsInventoryComponent
	{
		...
		public AvatarEffectsInventoryComponent(uint uint_1, GameClient class16_1, UserDataFactory class12_0)
		{
			...
			{
				AvatarEffect @class = new AvatarEffect((int)dataRow["effect_id"], (int)dataRow["total_duration"], Phoenix.smethod_3(dataRow["is_activated"].ToString()), (double)dataRow["activated_stamp"]);
				if (@class.Boolean_0)
				{
		...
		public void method_2(int int_1, bool bool_0)
		{
			if (this.method_4(int_1, true) || bool_0)
			{
				...
				{
					RoomUser class2 = @class.method_53(this.method_8().GetHabbo().Id);
					if (class2 != null && (class2.byte_1 <= 0 || int_1 == -1 || bool_0) && (class2.class34_1 == null || int_1 == 77 || int_1 == -1))
					{
						this.int_0 = int_1;
						if (class2.GetClient() != null && class2.GetClient().GetHabbo().CurrentQuestId == 19u && (this.int_0 == 28 || this.int_0 == 29 || this.int_0 == 30 || this.int_0 == 37))
						{
							Phoenix.GetGame().GetQuestManager().method_1(19u, class2.GetClient());
						}
		...
		public void method_3(int int_1)
		{
			...
			if (@class != null && !@class.Boolean_0 && !@class.bool_0 && (this.method_8() != null && this.method_8().GetHabbo() != null))
			{
				...
				if (class2 != null)
				{
					RoomUser class3 = class2.method_53(this.method_8().GetHabbo().Id);
		...
		{
			return this.Session.GetHabbo().Class14_0;
		}
	}
}
