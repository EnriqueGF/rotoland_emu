...
namespace Phoenix.HabboHotel.Users.Messenger
{
	internal sealed class HabboMessenger
	{
				...
				else
				{
					...
					if (!this.method_8(this.uint_0, num))
					{
						...
						if (class2 != null && class2.GetHabbo() != null)
						{
							...
							MessengerRequest class3 = new MessengerRequest(num2, num, this.uint_0, Phoenix.GetGame().GetClientManager().GetNameById(this.uint_0));
		...
		internal void method_17(uint uint_1, uint uint_2, uint uint_3)
		{
			...
			{
				this.hashtable_1.Add(uint_3, new MessengerRequest(uint_1, uint_2, uint_3, Phoenix.GetGame().GetClientManager().GetNameById(uint_3)));
			}
		}
			...
			else
			{
				...
				else
				{
					...
					else
					{
						...
						if (LicenseTools.Boolean_4 && !this.method_25().GetHabbo().isAaron)
						{
