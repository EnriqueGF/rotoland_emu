		...
		public void Handle(GameClient Session, ClientMessage Event)
		{
			try
			{
				...
				case "wf_act_give_phx":
				{
					...
					text2 = Phoenix.DoFilter(text2, false, true);
					...
					if (!(text2 == class2.string_2))
					{
						...
						if (Phoenix.GetGame().GetRoleManager().method_12(string_, Session))
						{
							class2.string_2 = text2;
						}
						else
						{
							Session.GetHabbo().method_28(PhoenixEnvironment.smethod_1("wired_error_permissions"));
						}
					}
					break;
				}
				case "wf_cnd_phx":
				{
					...
					if (!(text2 == class2.string_2))
					{
						...
						if (Phoenix.GetGame().GetRoleManager().method_11(string_, Session))
						{
							class2.string_2 = text2;
						}
						else
