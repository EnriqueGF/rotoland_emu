	...
	internal sealed class Licence
	{
		...
		public static bool smethod_0(bool bool_0)
		{
			...
			else
			{
				if (bool_0)
				{
                    //Phoenix.looknce.smethod_2(Phoenix.Nameauthor
				}
				return false;
			}
		}
		...
		public static string smethod_2(string string_0, bool bool_0)
		{
			...
			if (string_0 == @class.string_3)
			{
				...
				if (dictionary.ContainsKey("MinBuild"))
				{
					...
					LicenseTools.bool_17 = Convert.ToBoolean(dictionary["dce"]);
					LicenseTools.string_33 = dictionary["ExtraData"].Split(new char[]
					{
						':'
					})[0];
					LicenseTools.int_12 = (int)Convert.ToInt16(dictionary["ExtraData"].Split(new char[]
					{
						':'
					})[1]);
					LicenseTools.int_13 = (int)Convert.ToInt16(dictionary["ExtraData"].Split(new char[]
					{
						':'
					})[2]);
